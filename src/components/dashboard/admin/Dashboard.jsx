...
//       {
//         category: "Food",
//         message: "Food budget is at 85% of monthly limit",
//         percentageUsed: 85,
//         severity: "warning",
//       },
//       {
//         category: "Utilities",
//         message: "Utilities budget is at 92% of monthly limit",
//         percentageUsed: 92,
//         severity: "critical",
//       },
//     ],
...
//     stats.budgetAlerts?.forEach(alert => {
...
//               <div>
//                 <h4 className="font-semibold text-yellow-800">Budget Alerts</h4>
...
//                   {stats.budgetAlerts?.length || 0} active alerts
//                 </p>
//               </div>
//             </div>
//           </div>
...
//             onClick={() => toast.info("Manage Members feature coming soon!")}
//           >
...
const FALLBACK_DATA = {
  ...
  budgetAlerts: [
    ...
    },
    {
      id: 3,
      category: "Entertainment",
      message: "Entertainment budget is at 70% of monthly limit",
      percentageUsed: 70,
      severity: "warning",
      read: true,
    ...
    },
    {
      id: 4,
      category: "Transportation",
      message: "Transportation budget is at 45% of monthly limit",
      percentageUsed: 45,
      severity: "info",
      read: true,
      date: "2026-07-20T11:20:00",
    },
    {
      id: 5,
      category: "Groceries",
      message: "Groceries budget is at 95% of monthly limit",
      percentageUsed: 95,
      severity: "critical",
      read: false,
  ...
  householdDetails: {
    ...
    members: [
      { id: 1, name: "John Johnson", role: "Head of Household", email: "john@example.com", phone: "+1 (555) 123-4567" },
      { id: 2, name: "Jane Johnson", role: "Co-Head", email: "jane@example.com", phone: "+1 (555) 987-6543" },
      { id: 3, name: "Michael Johnson", role: "Member", email: "michael@example.com", phone: "+1 (555) 456-7890" },
      { id: 4, name: "Sarah Johnson", role: "Member", email: "sarah@example.com", phone: "+1 (555) 789-0123" },
    ],
  ...
  categoryBreakdown: [
    { category: "Food", amount: 850.50, percentage: 35 },
    { category: "Utilities", amount: 450.00, percentage: 18 },
    { category: "Transportation", amount: 320.75, percentage: 13 },
    { category: "Entertainment", amount: 280.50, percentage: 11 },
    { category: "Health", amount: 200.00, percentage: 8 },
    { category: "Other", amount: 349.00, percentage: 15 },
  ]
};
...
export const Dashboard = () => {
  ...
  const [allTransactions, setAllTransactions] = useState(FALLBACK_DATA.recentTransactions);
  const [householdDetails, setHouseholdDetails] = useState(FALLBACK_DATA.householdDetails);
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      setStats(prev => ({
        ...
        monthlyExpenses: statsResponse.data.monthlyExpenses || prev.monthlyExpenses,
      ...
      setAllTransactions(FALLBACK_DATA.recentTransactions);
      setHouseholdDetails(FALLBACK_DATA.householdDetails);
      setCategoryBreakdown(FALLBACK_DATA.categoryBreakdown);
    } finally {
      setIsLoading(false);
    }
  };
