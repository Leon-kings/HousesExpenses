    ...
    >
      <div className="flex flex-wrap justify-between items-start gap-2 mb-3">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs sm:text-sm text-gray-500 truncate">{budget.description || "No description"}</p>
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2.5 sm:h-3">
          <div 
            className={`h-2.5 sm:h-3 rounded-full transition-all duration-500 ${getStatusColor(status)}`}
      ...
      <div className="flex items-center justify-end mt-3 sm:mt-4 pt-3 border-t border-gray-100">
...
export const MyBudget = () => {
  ...
  // Load budgets from API using /email/:email endpoint
  const loadBudgets = useCallback(async () => {
    ...
    try {
      ...
      const url = `/budgets/email/${user.email}`;
      const params = {
        month: month,
        year: year
      };
  ...
  const exportReport = useCallback(() => {
    ...
    a.href = url;
    a.download = `my-budget-report-${selectedMonth+1}-${selectedYear}.csv`;
    a.click();
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 flex items-center gap-2">
              <AccountBalanceIcon className="text-blue-500 text-2xl sm:text-3xl" />
              My Budgets
            </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 border-l-4 border-purple-500">
            ...
            <p className="text-base sm:text-2xl font-bold text-purple-600 truncate">{formatCurrency(stats.totalAllocated)}</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 border-l-4 border-orange-500">
            <p className="text-xs sm:text-sm text-gray-500">Spent</p>
            <p className="text-base sm:text-2xl font-bold text-orange-600 truncate">{formatCurrency(stats.totalSpent)}</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 border-l-4 border-green-500">
            ...
            <p className="text-base sm:text-2xl font-bold text-green-600 truncate">{formatCurrency(stats.totalRemaining)}</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 border-l-4 border-blue-500">
            ...
            <p className="text-base sm:text-2xl font-bold text-blue-600 truncate">{stats.overallPercentage.toFixed(1)}%</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 border-l-4 border-indigo-500">
            <p className="text-xs sm:text-sm text-gray-500">Status</p>
            <p className="text-sm sm:text-lg font-bold text-indigo-600 flex items-center gap-1">
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 text-center">
            <AccountBalanceIcon className="w-16 h-16 sm:w-20 sm:h-20 text-gray-300 mx-auto mb-4" />
