...
//   // Read auth data synchronously on first render instead of waiting
//   // for an effect to run — avoids the blank-page flash on load.
...
//   // Only the stats section shows a loading state — not the whole page.
//   const [isStatsLoading, setIsStatsLoading] = useState(false);

//   // Static dashboard data for user view
//   const [stats, setStats] = useState({
//     totalExpenses: 1850.25,
//     monthlyExpenses: 720.50,
//     totalIncome: 3200.00,
...
//   // Redirect immediately if there's no valid session
//   useEffect(() => {
...
//   // Small reusable skeleton block for stat cards
//   const StatSkeleton = () => (
//     <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-gray-200 animate-pulse">
...
//             onClick={() => toast.info("Budget Settings feature coming soon!")}
//           >
//             <SavingsIcon className="w-8 h-8 mb-2" />
//             <h4 className="font-semibold">Budget Settings</h4>
//             <p className="text-sm opacity-90 mt-1">Set and manage budgets</p>
//           </motion.button>
//         </div>
...
//                 <p className="text-sm text-gray-600">Monitor every transaction</p>
//               </div>
//             </div>
//             <div className="flex items-start space-x-3">
...
//                 <p className="text-sm text-gray-600">Stay within your limits</p>
//               </div>
//             </div>
//             <div className="flex items-start space-x-3">
...
//                 <p className="text-sm text-gray-600">See household finances</p>
//               </div>
//             </div>
//             <div className="flex items-start space-x-3">
...
//               </div>
//               <div>
//                 <p className="font-semibold text-gray-800">Smart Insights</p>
//                 <p className="text-sm text-gray-600">Make better decisions</p>
//               </div>
//             </div>
//           </div>
//         </div>
